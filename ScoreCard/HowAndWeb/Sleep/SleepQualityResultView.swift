...
class SleepQualityResultView: UIView {
    ...
    override func layoutSubviews() {
        ...
        titleLabel.font = UIFont.systemFont(ofSize: 16 * bounds.width / 345, weight: UIFont.Weight.semibold)
        bottomLabel.font = UIFont.systemFont(ofSize: 18 * bounds.width / 345, weight: UIFont.Weight.semibold)
        // transform
