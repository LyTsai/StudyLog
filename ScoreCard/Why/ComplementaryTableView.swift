...
class ComplementaryTableView: UITableView, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = ComplementaryCardCell.cellWithTable(tableView, imageUrl: imageUrl, color: match.classification?.realColor, name: match.classification?.displayName)
