...
class ArcTextDrawView: UIView {
    ...
    func setTopArcWithFrame(_ frame: CGRect, angle: CGFloat, minRadius: CGFloat, attributes: [NSAttributedString.Key : Any]) {
    ...
    override func draw(_ rect: CGRect) {
        ...
        strokeString.addAttribute( .strokeColor, value: UIColor.black, range: totalRange)
        strokeString.addAttribute( .strokeWidth, value: NSNumber(value: 15), range: totalRange)
