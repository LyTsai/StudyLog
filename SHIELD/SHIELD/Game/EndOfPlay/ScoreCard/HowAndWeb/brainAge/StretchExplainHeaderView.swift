...
class StretchExplainCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        textLabel?.font = UIFont.systemFont(ofSize: 12 * bounds.width / 315, weight: .medium)
    }
}
...
class StretchExplainHeaderView: UIView {
    ...
    override func layoutSubviews() {
        ...
        // font
        capitalLabel.font = UIFont.systemFont(ofSize: 18 * one, weight: .bold)
        titleLabel.font = UIFont.systemFont(ofSize: 16 * one, weight: .bold)
    }
}
