...
class ScoreReferenceView: UIView {
    ...
    override func layoutSubviews() {
        ...
        // fonts of score
        scoreTitleLabel.font = UIFont.systemFont(ofSize: 14 * factor, weight: .semibold)
        scoreLabel.font = UIFont.systemFont(ofSize: 28 * factor, weight: .semibold)
        totalScoreLabel.font = UIFont.systemFont(ofSize: 14 * factor, weight: .semibold)
    ...
    func setupWithMeasurement(_ measurement: MeasurementObjModel) {
        ...
        if collection.getTierOfRisk(riskKey) != 2 {
