...
class MHCalendarPickerView: UIView ,UICollectionViewDelegate,UICollectionViewDataSource{
    //可变的日期
    var date :Date!
    //今天的日期
    var today :Date!
    ...
    //0
    class func showOnView(_ view:UIView) -> MHCalendarPickerView{
  
        let calendarPicker = Bundle.main.loadNibNamed("CalendarView", owner: self, options: nil)?.first as! MHCalendarPickerView
