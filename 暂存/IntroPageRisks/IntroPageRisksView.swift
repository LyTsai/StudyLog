...
//            collectionView.dequeueReusableCell(withReuseIdentifier: risks.count == 1 ? introPageRiskCellID : introPageRisksCellID, for: indexPath) as! IntroPageRiskCell
//        cell.hostView = self
//        cell.configureWithRisk(risks[indexPath.item])
//
//        // card like
//        if risks.count > 1 {
