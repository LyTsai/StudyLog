...
class ScorecardAlbumHeaderView: UIView {
    ...
    override func layoutSubviews() {
        ...
        nameLabel.font = UIFont.systemFont(ofSize: 14 * lineWidth, weight: UIFontWeightSemibold)
        
        typeLabel.layer.cornerRadius = typeLabel.bounds.height * 0.5
        typeLabel.layer.borderWidth = lineWidth * 2
        typeLabel.font = UIFont.systemFont(ofSize: 12 * lineWidth, weight: UIFontWeightSemibold)
    }
}
