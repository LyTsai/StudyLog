...
class CartCardsCollectionView: UICollectionView {
    ...
    fileprivate var editingMode = false
    func reloadWithCards(_ cards: [MatchedCardsDisplayModel], color: UIColor, mode: Bool) {
        self.cards = cards
        self.color = color
...
extension CartCardsCollectionView: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if editingMode {
            ...
            // change answer
            hostCell.hostTable.hostVC.bringUpWithCard(card.cardInfo, mainColor: color)
        }
