...
class TestViewController: ANTreeGraphViewController {
    var views = [[UIView?]]()
    var graphLinesView = ANTreeGraphLineView()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        graphLinesView.backgroundColor = UIColor.clearColor()
        graphLinesView.treeGraph = treeGraph
        graphLinesView.setUpDelegate()
        view.addSubview(graphLinesView)
        
    }
    
    override func viewDidLayoutSubviews() {
        super.viewDidLayoutSubviews()
        graphLinesView.frame = view.bounds
        
        graphLinesView.setNeedsDisplay()
    }
