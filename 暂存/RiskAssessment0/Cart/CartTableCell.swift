...
class CartTableCell: UITableViewCell {
    ...
    class func cellWithTableView(_ tableView: UITableView, cards: [MatchedCardsDisplayModel], color: UIColor) -> CartTableCell {
        ...
        cell!.setupWithCards(cards, color: color)
    ...
    fileprivate func setupWithCards(_ cards: [MatchedCardsDisplayModel], color: UIColor) {
        cartCardsView.reloadWithCards(cards, color: color)
