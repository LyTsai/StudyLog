...
extension CardTemplateView {
    ...
    func confirmButtonClicked() {
        ...
        if hostView != nil && hostView.isKind(of: AssessmentTopView.self) {
            ...
            // cache the result
            CardSelectionResults.cachedCardProcessingResults.addUserCardInput(UserCenter.sharedCenter.currentGameTargetUser, metricKey: vCard.metricKey!, cardKey: vCard.key, riskKey: RiskMetricCardsCursor.sharedCursor.focusingRiskKey!, selection: option, value: 1)
    ...
    func skipCard() {
        ...
        if hostView != nil && hostView.isKind(of: AssessmentTopView.self) {
            ...
            // skip the card
            CardSelectionResults.cachedCardProcessingResults.addUserCardInput(UserCenter.sharedCenter.currentGameTargetUser, metricKey: vCard.metricKey!, cardKey: vCard.key, riskKey: RiskMetricCardsCursor.sharedCursor.focusingRiskKey!, selection: nil, value: nil)
            topView.onValueSet(nil)
        }
...
extension MultipleChoiceCardsView {
    ...
    func chosenAsAnswer( _ button: UIButton) {
        ...
        if self.hostCardTemplateView.hostView != nil && self.hostCardTemplateView.hostView.isKind(of: AssessmentTopView.self) {
            ...
            CardSelectionResults.cachedCardProcessingResults.addUserCardInput(UserCenter.sharedCenter.currentGameTargetUser, metricKey: (vCard?.metricKey)!, cardKey: (vCard?.key)!, riskKey: RiskMetricCardsCursor.sharedCursor.focusingRiskKey!, selection: option, value: NSNumber(value: item))
...
extension SetOfCardsCardTemplateView {
    ...
    func goToNextCard() {
        ...
        if hostView != nil && hostView.isKind(of: AssessmentTopView.self) {
            ...
            // cache the result
            CardSelectionResults.cachedCardProcessingResults.addUserCardInput(UserCenter.sharedCenter.currentGameTargetUser, metricKey: vCard.metricKey!, cardKey: vCard.key, riskKey: RiskMetricCardsCursor.sharedCursor.focusingRiskKey!, selection: option, value: chosenIndex as NSNumber?)
