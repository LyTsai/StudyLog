...
class ScorecardResultPanel: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if forPercent {
            ...
            drawString(NSAttributedString(string: "%", attributes: [NSAttributedStringKey.font: UIFont.systemFont(ofSize: fontSize * 1.5, weight: UIFont.Weight.semibold), NSAttributedStringKey.foregroundColor: (forWhatIf ? UIColorFromHex(0x965FF1): UIColor.black)]), inRect: CGRect(x: vertex.x - sLength * 0.5, y: vertex.y - sLength, width: sLength, height: sLength))
            ...
            ctx1.saveGState()
            let titleString = NSMutableAttributedString(string: "Overall Scoring Thresholds", attributes: [NSAttributedStringKey.font: UIFont.systemFont(ofSize: fontSize * 1.4, weight: UIFont.Weight.medium), NSAttributedStringKey.foregroundColor: UIColor.black])
    ...
    fileprivate func drawNumberString(_ string: String, bottomPoint: CGPoint, left: Bool!) {
        ...
        let numberString = NSAttributedString(string: string, attributes: [NSAttributedStringKey.font: font])
