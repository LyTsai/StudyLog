...
class CoreTextArcView: UIView {
    ...
    var attributedString : NSAttributedString! {
        let attributes = [NSFontAttributeName: font, NSLigatureAttributeName: NSNumber(value: 0)] as [String : Any]
...
extension CoreTextArcView {
    override func draw(_ rect: CGRect) {
        ...
        for run in runArray as! Array<CTRun> {
             ...
             */
            if dimsSubstitutedGlyphs && !(font.isEqual(runFont)) {
