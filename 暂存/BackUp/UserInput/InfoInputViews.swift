...
//    }
    ...
    fileprivate var unitIndex = 0 {
        didSet{
            if unitIndex != oldValue {
                ...
                unitTable.reloadRows(at: [IndexPath(row: unitIndex, section: 0), IndexPath(row: oldValue, section: 0)], with: .automatic)
            }
        }
    }
    ...
    func changeState() {
        ...
        headerImageView.transform = headerImageView.transform.rotated(by: CGFloat(Double.pi))
