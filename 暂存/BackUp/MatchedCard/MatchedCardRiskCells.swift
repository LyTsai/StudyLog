...
let matchedRiskID = "matched card risk identifier"
class MatchedCardRiskCell: UITableViewCell {
    @IBOutlet weak var iconImageView: UIImageView!
    @IBOutlet weak var titleLabel: UILabel!
    @IBOutlet weak var riskDetailLabel: UILabel!
 
    class func cellWithTableView( _ tableView: UITableView, metric: MetricObjModel, risk: RiskObjModel) -> MatchedCardRiskCell {
        ...
        riskCell!.riskDetailLabel.text = risk.name
