...
//        dailyPlans = getRemindedPlans()
    ...
    override func viewDidLoad() {
        ...
        dailyPlans = getRemindedPlans()
        viewForAdd = ViewForAdd.createWithFrame(CGRect(x: 0, y: topLength, width: width, height: 370), topImage: UIImage(named: "reminder_golden"), title: "No active plans", prompt: "start one from \"all plans\"")
        view.addSubview(viewForAdd)
        
        reminderTable = ReminderTableView.createWithFrame(mainFrame, dailyPlans: dailyPlans)
