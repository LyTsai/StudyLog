...
@interface ASymbol_ManageWeights : APageLayerPath

// colors
@property(strong, nonatomic)UIColor* fillColor1;
@property(strong, nonatomic)UIColor* strokeColor1;
...
@property(strong, nonatomic)UIColor* gradientColor5;
