...
class DoEasyViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let titleLabel = UILabel(frame: CGRect(x: 0, y: 64, width: width, height: titleHeight))
        ...
        let setButton = UIButton.customNormalButton("Set Daily Reminders")
        setButton.adjustNormalButton(CGRect(center: CGPoint(x: setReminderView.bounds.midX, y: setReminderView.bounds.midY), width: width * 0.5, height: titleHeight * 0.8))
    ...
    func setDailyReminder() {
        ...
        let weekIndex = CalendarModel.getWeekIndexOfDate(easyPlansCollection.date)
