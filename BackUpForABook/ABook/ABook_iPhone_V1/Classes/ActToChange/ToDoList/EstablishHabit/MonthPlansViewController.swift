...
class MonthPlansTableViewController: UITableViewController {
    ...
    fileprivate func reloadDataSource() {
        ...
        let days = CalendarModel.getDaysOfMonthForDate(Date())
        
        if plans != nil {
            for day in days {
                let weekIndex = CalendarModel.getWeekIndexOfDate(day)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let simpleCell = PlanSimpleCell.cellWithTableView(tableView, text: plan.text, checked: plan.remindedWeeks.contains(CalendarModel.getWeekIndexOfDate(day)))
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        label.textColor = (CalendarModel.theSameDay(day1: day, day2: Date()) ? UIColorFromRGB(240, green: 130, blue: 100) : UIColor.black)
