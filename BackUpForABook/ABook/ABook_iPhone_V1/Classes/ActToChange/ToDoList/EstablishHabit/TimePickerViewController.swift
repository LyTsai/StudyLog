...
class TimePickerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // date picker
        datePicker.frame = CGRect(x: 0, y: 64, width: width, height: 250)
        ...
        // add
        let addButton = UIButton.customNormalButton("Add Time")
        addButton.adjustNormalButton(CGRect(x: 120, y: 360, width: 120, height: 60))
